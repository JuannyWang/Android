...
public class ChEnLrcView extends TextView{
	private float width;
	private float high;
	...
	public ChEnLrcView(Context context) {
		super(context);
		init();
		// TODO Auto-generated constructor stub
	}
	public ChEnLrcView(Context context, AttributeSet attrs) {
		super(context, attrs);
		init();
		// TODO Auto-generated constructor stub
	}
	public ChEnLrcView(Context context, AttributeSet attrs, int defStyle) {
