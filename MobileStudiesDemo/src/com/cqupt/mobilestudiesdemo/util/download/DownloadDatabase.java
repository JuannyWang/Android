...
/**
 * This database is stored on an external sd-card, more specifically, each
 * sd-card that has been used for downloading has it under
 * /jamendroid/downloads.db <br>
 * <br>
 * Database consists of one table LIBRARY, which basically contains all data
 * about the track plus info whether it has already been downloaded or not <br>
 * <br>
 * STATUS represents download progress of a track, track records are kept in the
 * LIBRARY table
 * 
...
public interface DownloadDatabase {
	 ...
	 * @return true if an resourceEntity already exists in the database
	 */
