...
public class ResourceAdapter extends ArrayListAdapter<ResourceEntity> {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (detailView == null) {
			...
			holder.rNameTextView = (TextView) detailView
		...
		holder.rNameTextView.setText(mList.get(position).getResourceTitle());
		return detailView;
	}

	static class ViewHolder {
		TextView rNameTextView;
