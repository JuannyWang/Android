...
import com.ghost.chatproject.ChooseActivity;
import com.ghost.chatproject.R;
import com.ghost.datas.Common;
import com.ghost.datas.LocalDataFactory;
...
public class LoadActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if (localDataFactory.getIsFirst()) {
			...
			Intent myIntent = new Intent(LoadActivity.this, ChooseActivity.class);
			// 设置快捷方式的标题
			...
			Utils.alertToast(getBaseContext(), tag, "成功在桌面创建快捷方式");
	...
	private void initView() {
		if(Utils.checkServiceAlive(getBaseContext(), Common.SERVICE_NAME)) {
			Intent intent = new Intent(LoadActivity.this,FriendListActivity.class);
