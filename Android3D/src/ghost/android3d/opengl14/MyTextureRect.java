...
public class MyTextureRect {
	...
	public MyTextureRect(float width, float height, int texId, float sRange,
			float tRange) {
		this.texId = texId;
		...
		float vertices[] = new float[] { width * UNIT_SIZE, height * UNIT_SIZE,
		...
		// 纹理 坐标数据初始化
		float[] texST = { sRange, 0, 0, 0, 0, tRange, 0, tRange, sRange,
				tRange, sRange, 0 };
