...
private SceneRenderer mRenderer;//场景渲染器	
	...
	private class SceneRenderer implements GLSurfaceView.Renderer 
    {
		...
		MyColorRect c1;//颜色矩形1
		MyColorRect c2;//颜色矩形2
		MyTextureRect t1;//纹理矩形1
		MyTextureRect t2;//纹理矩形2
...
//            gl.glBlendFunc(GL10.GL_SRC_COLOR, GL10.GL_DST_ALPHA);
            ...
            //创建矩形
            c1=new MyColorRect(one,0,0,one/3);
            c2=new MyColorRect(0,one,0,one/4);
            t1=new MyTextureRect(baseTextureId);
            t2=new MyTextureRect(topTextureId);
        }
    }
