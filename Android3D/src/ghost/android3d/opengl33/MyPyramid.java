...
public class MyPyramid {
	...
	public MyPyramid(int xOffset, int zOffset, float scale, float yAngle,
		...
		float vertices[] = new float[] { 0, 2 * scale * UNIT_SIZE, 0,
				UNIT_SIZE * scale, 0, UNIT_SIZE * scale, UNIT_SIZE * scale, 0,
				-UNIT_SIZE * scale,

				0, 2 * scale * UNIT_SIZE, 0, UNIT_SIZE * scale, 0,
		...
		// 顶点法向量数据的初始化================begin============================
		float normals[] = new float[] { 0.89443f, 0.44721f, 0f, 0.89443f,
				0.44721f, 0f, 0.89443f, 0.44721f, 0f,

				0, 0.44721f, -0.89443f, 0, 0.44721f, -0.89443f, 0, 0.44721f,
				-0.89443f,

				-0.89443f, 0.44721f, 0f, -0.89443f, 0.44721f, 0f, -0.89443f,
				0.44721f, 0f,
