...
public class MyIndexCube {
	...
	public MyIndexCube(float height, float length, float width) {
		this.height = height;
		float UNIT_SIZE = 0.5f;
		float UNIT_HIGHT = 0.5f;
		float[] verteices = { -UNIT_SIZE * length, UNIT_HIGHT * height,
				-UNIT_SIZE * width,// 0号点
				UNIT_SIZE * length, UNIT_HIGHT * height, -UNIT_SIZE * width,// 1号点
				-UNIT_SIZE * length, UNIT_HIGHT * height, UNIT_SIZE * width,// 2号点
				UNIT_SIZE * length, UNIT_HIGHT * height, UNIT_SIZE * width,// 3号点

				-UNIT_SIZE * length, -UNIT_HIGHT * height, -UNIT_SIZE * width,// 4号点
				UNIT_SIZE * length, -UNIT_HIGHT * height, -UNIT_SIZE * width,// 5号点
				-UNIT_SIZE * length, -UNIT_HIGHT * height, UNIT_SIZE * width,// 6号点
				UNIT_SIZE * length, -UNIT_HIGHT * height, UNIT_SIZE * width// 7号点
