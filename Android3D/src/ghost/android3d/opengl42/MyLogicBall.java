 ...
 * @date 2013-2-4
 */
public class MyLogicBall implements Constants {
	float vx;//球在X轴方向的速度
	float mass;//球的质量
	...
	MyBallControl bgt;
	public MyLogicBall(MyBall ball,float startX,float vx,float mass)
	{
		this.ball=ball;
		this.mass=mass;
		this.startX=startX;
	...
	public void move(ArrayList<MyLogicBall> ballAl)
	{
