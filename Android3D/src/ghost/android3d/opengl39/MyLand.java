...
public class MyLand {
    ...
    public MyLand(int texId,float[][] yArray,int rows,int cols)
    {
    	this.texId=texId;
        ...
        for(int j=0;j<rows;j++)
        {
        	...
        	{        		
        		//计算当前格子左上侧点坐标 
        		float zsx=-Constants.UNIT_SIZE*cols/2+i*Constants.UNIT_SIZE;
        		float zsz=-Constants.UNIT_SIZE*rows/2+j*Constants.UNIT_SIZE;        		
        		...
        		vertices[count++]=zsz+Constants.UNIT_SIZE;
        		
        		vertices[count++]=zsx+Constants.UNIT_SIZE;//矩形第四个点XYZ坐标
        		...
        		vertices[count++]=zsx+Constants.UNIT_SIZE;//矩形第三个点XYZ坐标
