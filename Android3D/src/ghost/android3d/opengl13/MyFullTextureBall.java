 ...
 * 
 */
package ghost.android3d.opengl13;
 ...
 * @date 2013-1-27
 */
public class MyFullTextureBall {
	...
	public MyFullTextureBall(float scale, int texId) {
		this.texId = texId;
		final int UNIT_SIZE = 10000;// 单位尺寸
		final float angleSpan = 11.25f;// 将球进行单位切分的角度

		// 获取切分整图的纹理数组
		float[] texCoorArray = generateTexCoor((int) (360 / angleSpan), // 纹理图切分的列数
