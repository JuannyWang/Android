...
private SceneRenderer mRenderer;//场景渲染器
    ...
    {   
		...
		MyTextureRect tr;//半透明反射面，用来 绘制比较真实的效果
		MyTextureRect trL;//普通反射面
    	MyBall btbv;//用于绘制的球
    	MyBallControl bfd;//用于控制的球
        ...
        public void onSurfaceCreated(GL10 gl, EGLConfig config) {
            ...
            //创建半透明篮球 板
            tr=new MyTextureRect(4,2.568f,lqcTMTexId);//用来 绘制比较真实的效果
            //创建普通不透明篮球板
            trL=new MyTextureRect(4,2.568f,lqcTexId);
            //创建用于绘制的球
            btbv=new MyBall(BALL_SCALE,basketballTexId);
            //创建用于控制的球
            bfd=new MyBallControl(btbv,3f);
        }
    }
