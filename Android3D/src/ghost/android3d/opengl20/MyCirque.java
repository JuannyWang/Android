 ...
 * 
 */
package ghost.android3d.opengl20;
...
public class MyCirque {
	...
	public MyCirque(float ring_Span, float circle_Span, float ring_Radius,
			float circle_Radius, int textureid) {
		...
		for (float circle_Degree = 0f; circle_Degree < 360f; circle_Degree += circle_Span) {
			for (float ring_Degree = -360f; ring_Degree < 0f; ring_Degree += ring_Span) {
				...
				float x3 = (float) ((ring_Radius + circle_Radius
						* Math.cos(Math.toRadians(circle_Degree + circle_Span))) * Math
						.cos(Math.toRadians(ring_Degree + ring_Span)));
				...
				float a1 = (float) (x1 - (ring_Radius * Math.cos(Math
						.toRadians(ring_Degree))));
				float b1 = y1 - 0;
				float c1 = (float) (z1 - (ring_Radius * Math.sin(Math
						.toRadians(ring_Degree))));
				...
				float a2 = (float) (x2 - (ring_Radius * Math.cos(Math
						.toRadians(ring_Degree + ring_Span))));
				float b2 = y1 - 0;
				float c2 = (float) (z2 - (ring_Radius * Math.sin(Math
						.toRadians(ring_Degree + ring_Span))));
				...
				float a3 = (float) (x3 - (ring_Radius * Math.cos(Math
						.toRadians(ring_Degree + ring_Span))));
				float b3 = y1 - 0;
				float c3 = (float) (z3 - (ring_Radius * Math.sin(Math
						.toRadians(ring_Degree + ring_Span))));
				...
				float a4 = (float) (x4 - (ring_Radius * Math.cos(Math
						.toRadians(ring_Degree))));
				float b4 = y1 - 0;
				float c4 = (float) (z4 - (ring_Radius * Math.sin(Math
						.toRadians(ring_Degree))));
