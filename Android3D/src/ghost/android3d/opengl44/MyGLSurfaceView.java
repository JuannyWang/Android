...
class MyGLSurfaceView extends GLSurfaceView {
	...
	private class SceneRenderer implements GLSurfaceView.Renderer 
    {
		...
		ghost.android3d.opengl43.MyPyramid MyPyramid;//烟火棱锥
		MyFireWorks fw;//焰火粒子系统
        ...
        public void onSurfaceChanged(GL10 gl, int width, int height) {
            ...
            //创建焰火棱锥
            MyPyramid=new ghost.android3d.opengl43.MyPyramid(0.6f,fuTexId);
            //创建焰火粒子系统
            fw=new MyFireWorks(ptexIdArray);
        }
