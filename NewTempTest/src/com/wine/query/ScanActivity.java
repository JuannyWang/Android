...
public class ScanActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		cameracallback = new CameraCallback(cameraview.getHolder(), limitwidth, limitheight, callback);
...
//					code.setText("扫描失败");
	...
	private void getsize()
	{
		if (tgtLeft == 0) {//只赋值一次
			...
			tgtWidth = (cameraview.getRight() - cameraview.getLeft())* 3
					/ 4;
			tgtHeight = (cameraview.getBottom() - cameraview.getTop())* 3
					/ 4;
