			...
			if (MapFunction.canDecrease(GameData.p1, GameData.p2, GameData.map)) {
				...
				if (list.size() == 0) {
					...
					if (tempPoint1.x > tempPoint2.x) {
						GameData.lines.add(new Line(tempX + tempPoint2.x * 60
								+ 25, tempY + tempPoint2.y * 60 + 25,
								(tempPoint1.x - tempPoint2.x) * 60, 10));
					} else if (tempPoint1.x < tempPoint2.x) {
						GameData.lines.add(new Line(tempX + tempPoint1.x * 60
								+ 25, tempY + tempPoint1.y * 60 + 25,
								(tempPoint2.x - tempPoint1.x) * 60, 10));
					} else if (tempPoint1.y > tempPoint2.y) {
						GameData.lines.add(new Line(tempX + tempPoint2.x * 60
								+ 25, tempY + tempPoint2.y * 60 + 25, 10,
								(tempPoint2.y - tempPoint1.y) * 60));
					} else if (tempPoint1.y < tempPoint2.y) {
						GameData.lines.add(new Line(tempX + tempPoint1.x * 60
								+ 25, tempY + tempPoint1.y * 60 + 25, 10,
								(tempPoint1.y - tempPoint2.y) * 60));
					}
				} else if (list.size() == 1) {
